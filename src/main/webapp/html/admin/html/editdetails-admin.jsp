    ...
    <div class="content2">
      ...
      <div class="middle-content" id="account">
        <form action="/action_page.java">
          ...
          <input type="text" id="fname" name="firstname" value="Pathum">

          <label for="lname">Last Name: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="lname" name="lastname" value="Wijewardhana">

          <label for="bio">Bio: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="bio" name="bio" value="Admin, Colombo District, Western, Sri Lanka">

          <label for="nic">Nic Number: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="nic" name="nic" value="725634270v">

          <label for="email">E-mail: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="email" name="email" value="WSpathum456@gmail.com">

          <label for="address">Address: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="address" name="address" value="No.400/4 Rajagiriya road, Colombo 07.">

          <label for="contactnum">Contact Number: <i class="fa fa-pencil-alt"></i></label>
          <input type="text" id="contactnum" name="contactnum" value="0766734980">
